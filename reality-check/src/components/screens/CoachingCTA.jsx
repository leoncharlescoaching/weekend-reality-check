...
export default function CoachingCTA({ onViewResults }) {
  // There's no further in-app screen after this one, so the primary CTA
  // opens the real booking link directly instead of trying to advance to
  // a next step that no longer exists. "Not ready yet" jumps back to the
  // Results screen instead of ending the interaction.
  ...
  return (
    <div className="flex h-full w-full flex-col overflow-y-auto no-scrollbar px-6 pb-8 pt-10 text-center">
      ...
      >
        ...
        <GhostButton onClick={onViewResults} className="mt-3">
          {CTA_COPY.skip}
        </GhostButton>
