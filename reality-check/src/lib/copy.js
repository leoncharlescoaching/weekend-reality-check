...
export const LANDING_COPY = {
  ...
  headline2: "Let's call your bullshit.",
  body: "Takes less than 60 seconds.\nFind out what's actually stopping your progress.",
...
export const CTA_COPY = {
  ...
  subheading: [
    ...
    "You have a weekend system problem.",
    "The good news?",
    "Systems can be fixed.",
  ],
  whyTitle: "Why people work with me",
  whyPoints: [
    "Weekend strategy built around real life",
    "Eat out without ruining progress",
    "Accountability before the weekend starts",
    "No calorie obsession",
    "No boring meal plans",
    "No starting again every Monday",
  ],
  imagineTitle: "Imagine 12 weeks from now...",
  imaginePoints: [
    "Your weekends don't fill you with guilt.",
    "Monday isn't another restart.",
    "Food doesn't control your decisions.",
    "You're finally making progress every week.",
  ],
  button: "BUILD MY WEEKEND STRATEGY →",
  skip: "Not right now",
  disclaimer: [
    "No pressure.",
    "No hard sell.",
    "Just an honest conversation to see if coaching is right for you.",
  ],
};

export const MONDAY_RESET_HEADLINE = "Monday Reset™";
export const MONDAY_RESET_CLOSER = "You don't need a new plan. You need to run the one you've got.";
...
const CATEGORY_COUPLETS = {
  Alcohol: (r) => {
    ...
    return [`${n} drinks isn't the problem.`, "It's what came with them."];
  },
  Takeaways: (r) => {
    const days = r.breakdowns.filter((b) => b.takeaway.value !== "none").length;
    const label = days === 1 ? "One takeaway" : `${days} takeaways`;
    return [`${label} isn't the problem.`, "It's what happened after it."];
  },
  Desserts: () => ["Dessert isn't the problem.", "Eating it without thinking is."],
  Snacking: () => ["A snack isn't the problem.", "Snacking all day is."],
  "Weekend Inactivity": () => ["Resting isn't the problem.", "Three days of it is."],
  "Poor Food Choices": () => ["No single meal broke this.", "The pattern across the weekend did."],
};

const CLOSING_COUPLETS = {
  Mild: ["You're closer than you think.", "Just tighten the small gaps."],
  Questionable: ["The gap's still small.", "But it's there, and it's real."],
  Delusional: ["You didn't lose progress on Monday.", "You lost it before Monday even started."],
  Dangerous: ["This isn't a one-off anymore.", "It's turning into the norm."],
  Nuclear: ["This wasn't really a weekend.", "It was a pattern wearing a disguise."],
};
...
export function buildRealityLines(results) {
  ...
  if (results.biggestKiller === CLEAN_WEEKEND_LABEL) {
    return [
      goalLine,
      "This time, you actually meant it.",
      "Friday, Saturday and Sunday all lined up.",
      "That's rare. Don't let it become an accident.",
    ];
  }
  ...
  const dayLine = `But ${day} had other ideas.`;
...
const CATEGORY_TIP = {
  Alcohol: (day) => `Skip alcohol next ${day}.`,
  Takeaways: (day) => `Swap the ${day} takeaway for a home-cooked meal.`,
  Desserts: (day) => `Skip dessert next ${day}.`,
  Snacking: (day) => `Plan ${day}'s meals so grazing has no gap.`,
  "Weekend Inactivity": (day) => `Hit 10,000 steps ${day} morning.`,
};

const GOAL_TIP = {
  lose_fat: "Eat protein before you go out.",
  build_muscle: "Hit your protein target before the weekend starts.",
  get_fitter: "Book the session in before Friday hits.",
  feel_better: "Prep Monday's breakfast on Sunday evening.",
};

const CLEAN_WEEKEND_TIPS = [
  "Keep Friday exactly like this.",
  "Same again next weekend.",
  "Don't let a good week make you sloppy.",
];
...
export const CHECKIN_COPY = {
  ...
  subheading: [
    "If you were one of my clients...",
    "This is exactly what I'd send you on Monday morning.",
  ],
  wellTitle: "What you did well",
  heldBackTitle: "What held you back",
  changeTitle: "What we change this week",
  closer: "The goal isn't a perfect weekend. It's a better one than last week.",
  dividerHeadline: "This is how people stop starting again every Monday.",
  dividerBody: [
    "One weekend doesn't define you.",
    "Repeating the same weekend every week does.",
    "Imagine having someone reviewing every weekend, adjusting the plan, and keeping you accountable until this becomes automatic.",
    "That's what coaching is.",
  ],
  ctaButton: "BUILD MY WEEKEND STRATEGY →",
  ctaSubtext: "See if coaching is the right fit for you.",
};
...
const WELL_DONE_LINES = {
  Alcohol: "You kept alcohol out of this weekend completely.",
  Takeaways: "You didn't order a single takeaway.",
  Snacking: "You didn't graze your way through the weekend.",
  "Weekend Inactivity": "You stayed active when it would've been easier not to.",
  Desserts: "You didn't reach for dessert once.",
};
...
function buildWellDone(results) {
  ...
  const goalLabel = GOAL_LABELS[results.goal] || "make progress";
  return `You said you want to ${goalLabel} — and you already know exactly what's in the way. That's further than most people get.`;
}
...
const CLEAN_CHECKIN = {
  wellDone: "Every category came back clean. That's not an accident.",
  heldBack: ["Nothing did.", "This is what alignment actually looks like."],
  actions: [
    "Keep this exact weekend as the template.",
    "Don't let a good week make you complacent.",
    "Same plan, every weekend, until it's automatic.",
  ],
};
...
const WEEKEND_PROFILES = {
  wrecker: {
    ...
    description: [
      "You don't ruin your progress in one meal.",
      "You ruin it through momentum.",
      "One takeaway becomes dessert.",
      "Dessert becomes grazing.",
      "By Sunday you're promising Monday will fix everything.",
      "You don't need another diet.",
      "You need to stop the weekend snowball.",
    ],
  },
  saboteur: {
    emoji: "🍺",
    ...
    description: [
      "Your weekdays are disciplined.",
      "Your weekends become permission to forget your goal.",
      "Food isn't your biggest issue.",
      "Social habits are.",
      "You don't need to stop enjoying yourself.",
      "You need a better strategy before you go out.",
    ],
  },
  grazer: {
    emoji: "🍫",
    title: "The Grazer",
    description: [
      "Meals aren't the problem.",
      "Everything between them is.",
      "The handfuls.",
      "The little bites.",
      "The snacks that don't feel like food.",
      "Those calories are adding up faster than you think.",
    ],
  },
  hibernator: {
    emoji: "🛋️",
  ...
  restarter: {
    ...
    description: [
      "You've become incredibly good at starting again.",
      "Every Monday feels different.",
      "Every Friday ends the same.",
      "The cycle isn't your motivation.",
      "It's your routine.",
    ],
  },
  clean: {
    ...
    description: [
      "Every category checked out clean.",
      "No wreckage. No spiral. No excuses needed.",
      "This is what alignment actually looks like.",
      "Don't treat it as a fluke.",
    ],
  },
};
